...
//go:generate minimock -i github.com/Reksy/mscommon/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/Reksy/mscommon/pkg/db"
